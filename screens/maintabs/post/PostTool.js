            ...
            <View style={styles.container}>
                <View style={styles.postToolWrapper}>
                    ...
                    <TouchableOpacity
                        ...
                        <View
                            style={{...styles.postInput, backgroundColor: this.state.inputBgColor}}>
                            <Text>
                ...
                <View style={styles.postOptionsWrapper}>
                    ...
                    <TouchableOpacity
                        ...
                        <View style={styles.postOptionItem}>
                            <FontAweSome5
                                style={styles.postOptionIcon}
                                name={isWriteToAnyOne || isWriteToPage ? 'image' : 'map-marker-alt'}
                                color="red"
                                size={16}
                            />
                            <Text>
...
export default connect(mapStateToProps, null)(PostTool);
