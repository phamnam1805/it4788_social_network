...
class FullPostTool extends Component {
    ...
    render() {
        ...
        const selectedBgColor = bgColors.filter(
            bgColor => bgColor.id === this.state.selectedBgColorId,
        )[0];
            ...
            <KeyboardAvoidingView style={styles.parentContainer} enabled behavior="height">
                <SafeAreaView style={styles.container}>
                    <View style={styles.navigationBar}>
                        <TouchableOpacity
                            onPress={this.onPressGoBackHandler.bind(this)}
                    ...
                    <Animated.View style={styles.toolOptionsWrapper}>
                        <View style={styles.bgColorsWrapper}>
                            <TouchableWithoutFeedback
                                ...
                                onPress={this.onTogglebBgColorListHandler.bind(this)}>
                                <Animated.Image
                                    style={{
                                        ...styles.bgImage,
                                            ...
                                            {!bgColor.isPureColor && (
                                                <TouchableWithoutFeedback
                                                    ...
                                                    <Image
                                                        ...
                                                        source={{uri: bgColor.bgImage_url}}></Image>
                                                </TouchableWithoutFeedback>
                                            )}
                                        </View>
                                    ))}
                        ...
                        <PanGestureHandler
                            ...
                            enabled={true}>
                            <Animated.View
                                style={{...styles.optionsWrapper, top: distanceTopOption}}>
                                <TouchableWithoutFeedback
                                    onPress={this.onPressShowOptions.bind(this)}>
                                    <View style={styles.optionTitle}>
                                        <Text style={{fontSize: 16}}>Add to your post</Text>
                                        <View style={styles.optionImagesWrapper}>
                                            <Image
                                                style={styles.optionImage}
                                                source={require('../../assets/icons/photo.png')}></Image>
                                            <Image
                                                style={styles.optionImage}
                                                source={require('../../assets/icons/friend.png')}></Image>
                                            <Image
                                                style={styles.optionImage}
                                ...
                                <TouchableOpacity onPress={() => console.log('do not thing')}>
                                    <View
                                        ...
                                        <Image
                                            ...
                                            source={require('../../assets/icons/live-news.png')}></Image>
                                ...
                                <TouchableOpacity onPress={() => console.log('do not thing')}>
                                    <View
                                        ...
                                        <Image
                                            ...
                                            source={require('../../assets/icons/photograph.png')}></Image>
                                ...
                                <TouchableOpacity onPress={() => console.log('do not thing')}>
                                    <View
                                        ...
                                        <Image
                                            ...
                                            source={require('../../assets/icons/letter-a.png')}></Image>
                                ...
                                <TouchableOpacity onPress={() => console.log('do not thing')}>
                                    <View
                                        ...
                                        <Image
                                            ...
                                            source={require('../../assets/icons/360-view.png')}></Image>
                                ...
                                <TouchableOpacity onPress={() => console.log('do not thing')}>
                                    <View
                                        ...
                                        <Image
                                            ...
                                            source={require('../../assets/icons/gif.png')}></Image>
                                ...
                                <TouchableOpacity onPress={() => console.log('do not thing')}>
                                    <View
                                        ...
                                        <Image
                                            ...
                                            source={require('../../assets/icons/popcorn.png')}></Image>
